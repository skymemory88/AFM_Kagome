...
class lattice
{
    public: 
        ...
        std::vector<T> NN(int x, int y); //call on all nearest neighbours
...
template <class T, LatticeForm format>
std::vector<T> lattice<T, format>::NN(int x, int y) //return vector index from input coordinates
{
    switch (format)
    {
    case LatticeForm::square:
...
template <class T, LatticeForm format>
std::vector<T> lattice<T, format>::NN(int x, int y, int z) //return the values of the nearest neighbours
{
    switch (format)
    {
    case LatticeForm::cubic:
...
template <class T, LatticeForm format>
std::vector<T> lattice<T, format>::NNN(int x, int y) //return the values of the next nearest neighbours
{
    switch (format)
    {
    case LatticeForm::square:
